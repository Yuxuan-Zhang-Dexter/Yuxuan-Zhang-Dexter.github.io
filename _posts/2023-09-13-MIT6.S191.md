...
Large gradients leads to exploding gradients and small gradients leads to vanishing gradients. 
solutions to vanishing gradients:
Activation Function - RelU
Parameter Initialization - initialize weights to identity matrix, initialize bias to zero
Gated Cells - long short term memory(LSTMs) networks rely on a gated cell to track information throughout many time steps (1.forget 2.store 3.update 4.output)

limitations of RNNs:
Encoding bottleneck; slow, no parallelization; not long memory
